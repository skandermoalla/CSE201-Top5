...
QT_MOC_LITERAL(3, 28, 21) // "on_pushButton_clicked"
    ...
    "Calendar\0backButtonClicked\0\0"
...
void Calendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Calendar::backButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Calendar::backButtonClicked()
{

...
QT_MOC_LITERAL(3, 28, 23) // "on_pushButton_5_clicked"
    ...
    "Training\0backButtonClicked\0\0"
...
void Training::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Training::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Training::backButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Training::backButtonClicked()
{
